...
So what *do* we get? We get the Ritt-Raud
...
\end{problem}
This problem is very open and Michael Singer (one of the authors of \cite{Put2003}) calls this the most important open problem in Differential Algebra. 
